...
namespace Uni.Scan.Reports.Reports {
    ...
    public class SITI_TASK_A4 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Uni.Scan.Reports.Reports.SITI-TASK-A4.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSITI_TASK_A4 : Component, ICachedReport {
        
        public CachedSITI_TASK_A4() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SITI_TASK_A4 rpt = new SITI_TASK_A4();
            rpt.Site = this.Site;
            return rpt;
        }

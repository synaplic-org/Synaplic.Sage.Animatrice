...
{
    public abstract class AuditableContext : IdentityDbContext<UniUser, UniRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, UniRoleClaim, IdentityUserToken<string>>
    {

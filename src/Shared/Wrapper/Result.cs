...
namespace Uni.Scan.Shared.Wrapper
{
    public class Result : IResult
    {
        ...
        public static Task<IResult<T>> FailAsync<T>(string v)
        {
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        public new static Result<T> Fail(string message, T data)
        {
        ...
        public new static Result<T> Fail(List<string> messages, T data)
        {
            return new Result<T> { Succeeded = false, Messages = messages, Data = data };
        }
        ...
        public new static Task<Result<T>> FailAsync(string message, T data)
        {
        ...
        public new static Task<Result<T>> FailAsync(List<string> messages, T data)
        {
            return Task.FromResult(Fail(messages, data));
        }

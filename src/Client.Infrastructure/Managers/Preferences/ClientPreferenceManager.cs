...
using Uni.Scan.Shared.Managers;
using Uni.Scan.Shared.Constants.Localization;

namespace Uni.Scan.Client.Infrastructure.Managers.Preferences
{
    ...
    public class ClientPreferenceManager : IClientPreferenceManager
    {
        ...
        public async Task<IResult> ChangeLanguageAsync(string languageCode)
        {
            ...
            if (preference != null)
            {
                ...
                {
                    Succeeded = true,
                    Messages = new List<string> { _localizer["Client Language has been changed to "] + languageCode }
                };
            }
        ...
        public async Task<string> GetCurrentLanguageCodeAsync()
        {
            ...
            return LocalizationConstants.SupportedLanguages[0].Code;
        }
        public async Task<MudTheme> GetCurrentThemeAsync()
        {
            ...
            if (preference != null)
            {
                if (preference.IsDarkMode == true) return UniTheme.DarkTheme;
            }
            return UniTheme.DefaultTheme;
        }

...
namespace Uni.Scan.Client.Infrastructure.Managers.Identity.Users
{
    public interface IUserManager : IManager
    {
        ...
        Task<IResult> UpdateUserAsync(UpdateUserRequest request);
    ...
    public class UserManager : IUserManager
    {
        ...
        public async Task<IResult> UpdateUserAsync(UpdateUserRequest request)
        {
            var response = await _httpClient.PutAsJsonAsync(Routes.UserEndpoints.UpdateUser, request);
            return await response.ToResult();
        }
